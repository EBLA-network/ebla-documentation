...
{% hint style="warning" %}
**Disclaimer**: This white paper is intended as a preliminary technical overview of the EBLA protocol and ecosystem and is not meant to be comprehensive or fully finalized.
{% endhint %}
...
In this whitepaper, we introduce EBLA, a fast & scalable public ledger purpose-built to help minimize business friction. EBLA implements the following key technical innovations:
