---
description: Guide for running the EBLA Node with Docker on Linux
---
...
The node will start after Docker pulls the latest EBLA Node image.

![Node Running](../../.gitbook/assets/4-ebla.png)

_NOTE: You can press `CTRL` + `C` to stop displaying the logs_

## 4. Update the EBLA Node
