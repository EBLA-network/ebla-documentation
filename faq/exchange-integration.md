---
description: >-
  This document describes how you can add EBLA's native token, EBLA, to a
  crypto exchange.
---
...
To connect to the EBLA chain you can use either a **Consensus Node** or a **RPC Node**.
...
The EBLA Chain is compatible with the Ethereum chain. That means that most default Ethereum RPC requests will work on EBLA.
...
The compatibility with Ethereum means that almost all tools from the Ethereum ecosystem work with EBLA. You can use, for example, [Web3.js](https://web3js.org/), [ethers.js](https://docs.ethers.io/v5/) and [Web3.py](https://web3py.readthedocs.io/en/latest/) to connect to and interact with the EBLA Network.
