...
There is a 1,000 EBLA self-staking requirement to register with the on-chain DPoS contract. At the time of this writing 1,000 EBLA isn't a lot of money, and this is not meant to be collateral, but rather to deter spamming attacks on the DPoS contract.&#x20;



### How do Validators produce blocks?&#x20;

Validators receive delegation of EBLA tokens. A minimum delegation of 500k EBLA is required to start producing blocks, and each Validator can take on a maximum of 80 million EBLA of delegated stake. The more delegated EBLA a Validator has, the more likely and more frequently it will produce blocks.&#x20;
...
You can see a list of current Validators, their delegation, yields efficiency and commissions on the [EBLA Community Site's Staking section](https://community.eblanetwork.com/staking).&#x20;
