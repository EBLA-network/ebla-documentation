---
description: EBLA supports all ETH-compatible wallets!
---

# 💵 Wallet

## EBLA supports all ETH-compatible wallets

The EBLA network is backwards-compatible with Ethereum, that means any ETH-compatible wallet that allows you to add a custom, EVM-compatible network will work with EBLA!&#x20;

This means that,&#x20;

* All Ethereum wallets can be used on EBLA
* All EBLA wallets can used on Ethereum&#x20;
...
Here are a few examples of wallets supported by EBLA.&#x20;
