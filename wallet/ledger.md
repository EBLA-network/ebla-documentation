---
description: Using EBLA on the Ledger hardware wallet
---

# Ledger

## Create a EBLA wallet on Ledger

Since EBLA is ETH-compatible, all you need to do is create a regular ETH wallet on Ledger. We'll use this in conjunction with Metamask to get up & running on the EBLA network!&#x20;
...
Now that you have an Ethereum wallet on your Ledger, let's connect it with Metamask to get it working with the EBLA network.&#x20;



## Connect Ledger's with EBLA through Metamask

Because the EBLA Network is ETH-compatible, the Ethereum App actually works fine with the EBLA Network, but needs to work through Metamask.&#x20;
...
* [Add the EBLA network into Metamask](metamask.md)&#x20;
* Use Metamask to send / receive EBLA, and it will be signed by your wallet on the Ledger ETH app

This works because the EBLA network is compatible with Ethereum's address and cryptography, so when Metamask sends a request for signature for the EBLA network to the Ledger's ETH app, everything just works.&#x20;
